...
public class ProducerMain {
    ...
    public static Producer<String,String> createProducer(){
        ...
        properties.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG,"10.228.131.21:9092");
        /**
         *  发出消息持久化机制参数
        ...
        properties.put(ProducerConfig.RETRY_BACKOFF_MS_CONFIG, 300); //重试间隔设置
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        for (int i = 1; i <= msgNum; i++) {
            ...
            ProducerRecord<String, String> producerRecord  = new ProducerRecord<>(TOPIC_NAME, "key"+i, "artzxl"+i);
